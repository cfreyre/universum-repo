$(document).ready(function() { 
	...
	function onloadevent(){
		...
		// updated()
		//Menu Code
		var menu_html = '<li class="headlink first" style="width:100px"><a href="index.htm">Inicio</a>'+
		'<li class="headlink" style="width:134px"><a href="branch.htm">Tiendas</a>'+						 
		'<ul class="three-levels" >'+
		'	<li class="head"><a href="branch.htm#rv">Revolución</a></li><li class="clear"></li>'+
		'	<li class="head"><a href="branch.htm#gv">Gustavo Baz</a></li><li class="clear"></li>'+
		'</ul>'+
		'</li>'+
		'<li class="headlink" style="width:134px"><a href="products.htm">Productos</a>'+
		'<li class="headlink" style="width:134px"><a href="local_courses.htm">Cursos</a>'+
		'<ul class="three-levels" >'+
		'	<li class="head"><a href="local_courses.htm">En instalaciones</a></li><li class="clear"></li>'+
		'	<li class="head"><a href="internet_courses.htm">Por Internet</a></li><li class="clear"></li>'+
		'</ul>'+
		'</li>'+
		' 	<li class="headlink   " style="width:184px"><a href="formulations.htm">Formulaciones</a></li>';
		$("#menu").html(menu_html);
		
		//Footer code
		// var footer_html = ' <div class="inner"><span id="author" style="color: #555;"><a>Teléfonos: 5593 9208 / 8990 / 9219 Fax: 5660 5391 Lada sin costo: 01 800 832 2259 e-mail: drocosmo@prodigy.net.mx</a></span><span id="copy" style="color: #555;"><a>Derechos Reservados © 2012</a></span></div>';
		var footer_html = ' <div class="inner"><span id="author" style="color: #555;"><a>Teléfonos: 5593 9208 / 8990 / 9219 Fax: 5660 5391 Lada sin costo: 01 800 832 2259 e-mail: drocosmo@prodigy.net.mx</a></span><span id="copy" style="color: #555;"></span><span><a href="privacy.htm">Aviso de Privacidad</a></span></div>';
...
var _gaq = _gaq || [];
_gaq.push(['_setAccount', 'UA-7742711-1']);
